...
//  Company info
 if (get_locale() == 'pl_PL') { $descFooter   =  get_theme_mod('desc'); } else { $descFooter   =  get_theme_mod('desc-en');}

 if (get_locale() == 'pl_PL') { $address  = get_theme_mod( 'address' ); } else { $address  = get_theme_mod( 'address_en' ); }
 if (get_locale() == 'pl_PL') { $address_url  = get_theme_mod( 'address_url' ); } else { $address_url  = get_theme_mod( 'address_url_en' ); }
 
 if (get_locale() == 'pl_PL') { $phone  = get_theme_mod( 'phone' ); } else { $phone  = get_theme_mod( 'phone_en' ); }
 if (get_locale() == 'pl_PL') { $phone_url  = get_theme_mod( 'phone_url' ); } else { $phone_url  = get_theme_mod( 'phone_url_en' ); }
 
 if (get_locale() == 'pl_PL') { $email  = get_theme_mod( 'email' ); } else { $email  = get_theme_mod( 'email_en' ); }
 if (get_locale() == 'pl_PL') { $email_url  = get_theme_mod( 'email_url' ); } else { $email_url  = get_theme_mod( 'email_url_en' ); }
 ...
 <div class="brand-inf">
     ...
     <div class="inf">
         ...
         <?php } ?>
            ...
            <path id="Shape_19" data-name="Shape 19" d="M216,4090s-7-9.13-7-13a7,7,0,0,1,14,0C223,4080.87,216,4090,216,4090Zm0-11a2,2,0,1,0-2-2A2,2,0,0,0,216,4079Z" transform="translate(-209 -4070)" fill="#3497db"/>
            </svg>
     ...
     <div class="inf">
         <?php if ($phone_url) { ?>
         <a href="<?php echo $phone_url; ?>" target="_blank">
         <?php } ?>
